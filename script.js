/*
Should have used APIs, next to study
*/
(function(){
 
    let body = document.querySelector("body");
    let obi = document.querySelector("article");
    let odas = document.querySelector("aside");
    let button = document.querySelector("button");
    let poster = document.querySelector("section");
